...
public class DataDrivenTest extends DataDrivenTestCase{
	String medicine="";
	String submedicine="";
	boolean expected;
	...
	public DataDrivenTest(String medicine,String submedicine){
		super();
	...
	public DataDrivenTest(String testName,boolean expected){
		super();
	...
	public static Test suite(){
		...
		while(it.hasNext()) {
				...
				suite.addTest(new DataDrivenTest(testName,expected));
			}
		return suite;
